...
A: Your CSV file should have a header row with column names. The contact_number column must contain valid phone numbers in the format: contact_number: +911234567890 (with +91 prefix). For example: contact_number,name\n+911234567890,John Doe\n+919876543210,Jane Smith

Q: What is the expected CSV format?
A: The CSV file should contain a contact_number column with phone numbers with +91 prefix. Example: contact_number: +911234567890

Q: Can you show me an example CSV format?
A: Yes! Here is an example CSV structure:\ncontact_number,name,company\n+911234567890,John Doe,Acme Corp\n+919876543210,Jane Smith,Tech Solutions\nThe contact_number field must be formatted as: +91 followed by 10 digits

Q: How can I add CSV?
A: To add a CSV file, go to Dashboard → Campaigns → Create Campaign, then upload your CSV file with phone numbers in the format: contact_number: +911234567890 (with +91 prefix).

Q: How should I structure my CSV file?
A: Your CSV file should have a header row with column names. The contact_number column must contain valid phone numbers formatted as: contact_number: +911234567890 (with +91 prefix). Example: contact_number,name,company\n+911234567890,John Doe,Acme Corp\n+919876543210,Jane Smith,Tech Solutions

Q: How to create CSV file?
A: Create a CSV file using any text editor or spreadsheet application. Structure it with: contact_number,name,company as headers, then list your data with phone numbers in the format: +911234567890 (with +91 prefix). Save the file as .csv format. Example:\ncontact_number,name,company\n+911234567890,John Doe,Acme Corp\n+919876543210,Jane Smith,Tech Solutions
