...
Q: How can I add CSV?
A: To add a CSV file, go to Dashboard → Campaigns → Create Campaign, then upload your CSV file with phone numbers in the format: contact_number: 1234567890 (10-digit format without spaces or special characters).

Q: How should I structure my CSV file?
A: Your CSV file should have a header row with column names. The contact_number column must contain valid phone numbers formatted as: contact_number: 1234567890 (10 digits only, no spaces). Example: contact_number,name,company\n1234567890,John Doe,Acme Corp\n9876543210,Jane Smith,Tech Solutions

Q: How to create CSV file?
A: Create a CSV file using any text editor or spreadsheet application. Structure it with: contact_number,name,company as headers, then list your data with phone numbers in the format: 1234567890 (10 digits only). Save the file as .csv format. Example:\ncontact_number,name,company\n1234567890,John Doe,Acme Corp\n9876543210,Jane Smith,Tech Solutions
